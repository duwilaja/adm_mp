                                ...
                                <div class="">
                                        <div class="shop-tabs-menu " id="st-menu">
                                            <ul class="tabs-menu fl-wrap no-list-style">
                                                <li class="current"><a href="#shop-tab1"> Biodata Diri</a></li>
                                                <li><a href="#shop-tab2">Daftar Alamat</a></li>
                                            </ul>
                                        </div>
                                        <!-- shop-tabs--> 
                                        <!-- shop-tabs--> 
                                                                    ...
                                                                    <div class="row">
                                                                            ...
                                                                            <div class="list-single-main-item-title fl-wrap">
                                                                                <div class="add-list-media-wrap">
                                                                                    <div class="add-list-media-wrap">
                                                                                        ...
                                                                                        <a class="back-tofilters color-bg custom-scroll-link fl-wrap" style="z-index: 12;">Pilih Foto<i class="fas fa-caret-up"></i></a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-8">
                                                                                            <div class="list-author-widget-contacts list-item-widget-contacts bwc-padside">
                                                                                                <div class="list-single-main-item-title fl-wrap">
                                                                                                    <h3><span>Biodata Diri</span></h3>
                                                                                                </div>
                                                                                                <ul class="no-list-style">
                                                                                                        <li><span> Nama </span> <a href="#singleMap" class="custom-scroll-link">Nanang Sunaryo</a><a><i class="fal fa-edit"></i></a></li>
                                                                                                        <li><span> Tanggal Lahir </span> <a href="#"></a></li>
                                                                                                        <li><span> Jenis Kelamin </span> <a href="#"></a></li>
                                                                                                </ul>
                                                                                            </div>
                                                                                            <div class="list-author-widget-contacts list-item-widget-contacts bwc-padside">
                                                                                                <div class="list-single-main-item-title fl-wrap">
                                                                                                ...
                                                                                                <ul class="no-list-style">
                                                                                                        <li><span> Email </span> <a href="#singleMap" class="custom-scroll-link">nanang@gmail.com</a></li>
                                                                                                        <li><span> Nomor HP </span> <a href="#">0822-1111-2222</a></li>
                                                                                                </ul>
                                                                                            </div>
                                                    ...
                                                    <div id="shop-tab2" class="tab-content">
                                                        <div class="shop-tab-container">
                                                            <ul class="no-list-style shop-list fl-wrap">
                                                                <li><span>Product Number :</span>#41121120</li>
                                                                <li><span>Ingredients : </span> meat ,  mustard  , ketchup ,  bread</li>
                                                                <li><span>The weight : </span>  5 pounds / 2,3 kg</li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div id="shop-tab3" class="tab-content">
                                                        ...
                                                        <div id="add-review" class="shop-review-box fl-wrap">
                                                            ...
                                                            <div class="leave-rating-wrap">
                                                                <span class="leave-rating-title">Add a review: </span>
