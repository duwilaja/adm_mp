	...
	<div class="col-list-wrap novis_to-top">
		...
		<div class="list-main-wrap-header fl-wrap fixed-listing-header">
			<div class="container">
				...
				<div class="list-main-wrap-title">
					<h2>Hasil Pencarian : <span id="r_cari">- </span></h2>
				</div>
		...
		<div class="listsearch-input-wrap lws_mobile fl-wrap tabs-act" id="lisfw">
			...
			<div class="container">
				...
				<div class="tabs-container fl-wrap">
					<!--tab -->
					<div class="tab">
						<form action="javascript:void(0);" method="post" id="form_cari">
									...
									<div class="row">
										...
										<div class="col-md-4">
											<div class="listsearch-input-item">
												...
												<input type="text" name="q" placeholder="Apa yang kamu cari ?" value=""/>
											</div>
										</div>
										...
										<div class="col-md-3">
											<div class="listsearch-input-item">
												<button type="submit" class="header-search-button color-bg" ><i class="far fa-search"></i><span>Cari</span></button>
											</div>
										</div>
										<!-- listsearch-input-item end-->                                         
									</div>
		...
		<div class="listing-item-container init-grid-items fl-wrap">
			<div class="container" id="daftar_cari">
				<!-- listing-item  -->
