<header class="main-header">
    <!-- logo-->
    <a href="index.html" class="logo-holder"><img src="<?=base_url('template2/');?>images/logo.png" alt=""></a>
    <!-- logo end-->
    <!-- header-search_btn-->         
    <div class="header-search_btn show-search-button"><i class="fal fa-search"></i><span>Cari</span></div>
    ...
    <div class="show-reg-form modal-open avatar-img" data-srcav="<?=base_url('template2/');?>images/avatar/4.jpg"><i class="fal fa-user"></i>Sign In</div>
    <!-- header opt end--> 
    <!-- lang-wrap-->
    <div class="lang-wrap">
    ...
    <div class="nav-holder main-menu">
        <nav>
            <ul class="no-list-style">
                <li>
                    <a href="<?=site_url()?>" class="act-link">Beranda </a>
                </li>
                
                <li>
                    <a href="produk.html">Produk</a></li>
                <li>
                    <a href="vendor.html">Vendor</a>
                </li>
                <li>
                    <a href="<?=site_url('Blog')?>">Artikel</a>
                </li>
